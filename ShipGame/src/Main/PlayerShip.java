...
//TODO Improve the drawing of the ship
	...
	Point2D.Double thirdPoint = new Point2D.Double(shipCenterPoint.getX(),shipCenterPoint.getY()+10);
	Point2D.Double fourthPoint = new Point2D.Double(shipCenterPoint.getX()+15,shipCenterPoint.getY()+20);
